...
class Parser:
    ...
    # func: the function self.factor or self.term, that deals with the number node extraction of the tree.
    # ops: the operators that will be dealed with in this function.
